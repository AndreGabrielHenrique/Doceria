// Componente React para galeria de imagens "Grande Variação" com funcionalidades de modal interativo
// Local: src/components/Variacao/Variacao.jsx

import React, { useState, useEffect, useRef } from 'react'
import './Variacao.sass'
// Importações otimizadas das imagens da galeria
...
import swipe from '../../assets/Imagens/swipe.gif' // GIF animado para tutorial de swipe em mobile

// Array estruturado de imagens com metadados (fonte e texto alternativo)
const imagens = [
  { src: galeria1, alt: 'Muitos doces' },
  { src: galeria2, alt: 'Bolo' },
  { src: galeria3, alt: 'Confeitaria' },
  { src: galeria4, alt: 'Doces aos montes' },
  { src: galeria5, alt: 'Cupcakes' }
]
